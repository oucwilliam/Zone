<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WriteLogs.aspx.cs" Inherits="qqZoneHome_WriteLogs" %>
...
<body>
    ...
    <form id="example" runat="server">
        ...
        <br />
        <asp:Button ID="BtnAdd" runat="server" Text="提交日志" OnClick="BtnAdd_Click"/> 
