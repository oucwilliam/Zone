...
public partial class qqZoneHome_Message : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            string UserName = Convert.ToString(Session["FriendName"]);
    ...
    protected void BtnAdd_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string sql = "Insert into Message values ('0',N'" + FriendName + "','" + UserName + "','" + Message + "')";
            SQL.sqlIDU(sql);
    ...
    protected void BtnSave2_Click(object sender, EventArgs e)
    {
        ...
        {
            string sql = "Insert into Message values ('" + id + "',N'" + FriendName + "','" + UserName + "','" + NewComment + "')";
            SQL.sqlIDU(sql);
